...
for iterator_4 in range(tiers):
    ...
    if (iterator_4 == 0):
        master_k_mean_points[iterator_4] = point_list_2_k_mean_point_object(starting_injector_points,  starting_weights)
    else:
...
for iterator_5 in range(len(master_curves)):
	for iterator_4 in range(len(master_curves[iterator_5])):
		master_curves[iterator_5][iterator_4].populate_curve_with_circle_info(total_weights, combined_outlet_surface_area, lofting_exponent)
