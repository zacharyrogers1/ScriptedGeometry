...
def tangent_direction(incoming_curve, evaluation_point):
	...
	X1 = top_point.X - bottom_point.X #Find the tangent direction by finding the vector between the two very close points
	Y1 = top_point.Y - bottom_point.Y
	Z1 = top_point.Z - bottom_point.Z
...
coolant_center_circle_point = Point.Create(-.004, 0,0)
...
options.SweepNormalTrajectory = True
